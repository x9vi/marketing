...
import { Prisma, Role, SaleStatus, PaymentMethod, InventoryMovementType, AdjustmentReason, DiscountType, Unit } from '@prisma/client';
...
function sendAuthUser(user: { id: string; email: string; name: string; role: Role }) {
